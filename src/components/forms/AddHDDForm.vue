<template>
  ...
  >
    ...
    >
      ...
      >
        <n-input
          ...
          placeholder="Например, Caviar Blue"
        />
      </n-form-item-gi>
      <n-form-item-gi
        label="Стоимость (₽)"
    ...
    >
      <n-form-item-gi
        label="Общий объем накопителя, Гб"
      ...
      <n-form-item-gi
        label="Объём буферной памяти, Мб"
        path="productBufferMemoryCapacity"
      >
        <n-input-number
          v-model:value="model.productBufferMemoryCapacity"
          :min="0"
          :step="120"
          placeholder="Например, 1000"
        />
      ...
      <n-form-item-gi
        ...
        path="productSpindleSpeed"
      >
        <n-input-number
          v-model:value="model.productSpindleSpeed"
          :min="0"
          :step="50"
...
const rules: FormRules = {
  ...
  productBufferMemoryCapacity: {
    type: 'number',
    required: true,
    trigger: ['blur', 'change'],
    message: 'Необходимо указать объем буферной памяти',
  },
  productSpindleSpeed: {
    type: 'number',
    required: true,
    trigger: ['blur', 'change'],
    message: 'Необходимо указать скорость вращения шпинделя',
  },
};
...
const formModel = {
  ...
  productBufferMemoryCapacity: null,
  productSpindleSpeed: null,
};
